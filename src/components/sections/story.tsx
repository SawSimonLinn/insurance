      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="space-y-4 text-lg text-foreground/80">
            ...
            <p>
              As a family that moved from another country and built a life here
              in the United States, we understand the challenges of starting
              fresh. That experience inspired our mission — to help every
              Hoosier, every neighbor, and every entrepreneur find peace of mind
              through protection that fits their unique journey.
            </p>
            <p>
              Driven by honesty, integrity, and compassion, we’ve built
              long-term relationships with our clients — not just by offering
              coverage, but by being there when it matters most.
            </p>
          </div>
        </div>
