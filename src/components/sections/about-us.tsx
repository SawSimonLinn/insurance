        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-last md:order-first">
            ...
            <div className="mt-6 space-y-4 text-lg text-foreground/80">
              ...
              <p>
                At Venture Quality Insurance Agency, our values of honesty,
                integrity, excellence, and compassion guide everything we do.
                These principles are at the heart of every policy we write,
                every client we serve, and every relationship we build.
              </p>
            </div>
        ...
        <div className="mt-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {values.map((value) => (
              <Card
                key={value.name}
                className="text-center bg-card shadow-md transition-transform hover:scale-105"
              >
