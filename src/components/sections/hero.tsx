    ...
    <section className="relative h-[70vh] md:h-[500px] w-full flex items-center justify-center text-center text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        ...
        <p className="mt-6 text-base md:text-xl max-w-3xl mx-auto text-primary-foreground/90">
          ...
          coverage, while providing excellent customer service and quality
          products. We are ready to help you protect your family, homes, autos,
          business, and healthcare every step of the way.
        </p>
        <div className="mt-8">
          <Button
            asChild
