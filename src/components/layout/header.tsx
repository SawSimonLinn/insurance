    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto flex h-20 max-w-screen-2xl items-center justify-between px-4">
        ...
        <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
          ...
          <Link href="/about#services" className="hover:text-primary transition-colors">Services</Link>
        </nav>
        <div className="flex items-center gap-4">
            <a href="tel:555-555-5555" className="hidden sm:flex items-center space-x-2 text-sm font-medium hover:text-primary whitespace-nowrap">
               ...
               <Sheet>
                  ...
                  <SheetContent side="right" className="flex flex-col p-0">
                    ...
                    <div className="mt-auto p-4 space-y-4 border-t">
                        ...
                        <a href="tel:555-555-5555" className="flex items-center justify-center space-x-2 text-sm font-medium hover:text-primary whitespace-nowrap pt-2">
                            <Phone className="h-4 w-4 text-primary" />
                            <span>(555) 555-5555</span>
                        </a>
                    </div>
